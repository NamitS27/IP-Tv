...
// ----------------- The struct used for information regarding channels which is received via TCP -------//
...
// ----------------- This is the actual stuct which is received over TCP --------------//
...
int main(int argc, gchar *argv[])
{
    ...
    gtk_signal_connect_object(GTK_OBJECT(button_fetch), "clicked",GTK_SIGNAL_FUNC(get_station_list), (gpointer)clist);
